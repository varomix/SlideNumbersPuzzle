...
class Instructions extends FlxSubState
{
	...
	override public function create():Void
	{
		...
		var title2 = new FlxText(0, 0, FlxG.width, "\nSlide Numbers Puzzle", 50);
		...
		var inst = new FlxText(0, 380, FlxG.width, "Put the numbers\nin order in the least\nmoves possible.\n\nGood luck!!");
		inst.setFormat("assets/data/LuckiestGuy.ttf", 50, FlxColor.WHITE, FlxTextAlign.CENTER);
		// inst.screenCenter(true, false);
		add(inst);


		var playBtn = new FlxButton(FlxG.width/2 - 100, 800, "PLAY", function(){ click_snd.play(); close(); } );
